...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{figures/Implizit_Ent_3_1_7/Test_0-eps-converted-to}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{figures/Implizit_Ent_3_1_7/Test_1-eps-converted-to}
