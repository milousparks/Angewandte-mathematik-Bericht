...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/Implizit_Ent_3_1_7/Test_0-eps-converted-to}
	\caption{implizite Euler-Verfahren}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/Implizit_Ent_3_1_7/Test_1-eps-converted-to}
