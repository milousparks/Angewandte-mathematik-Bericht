...
\mathbf{A}=	\begin{bmatrix}
		-\frac{2hS_R+2D+kh^2}{h^2} & \frac{2D}{h^2} & \dots &  \dots &  \dots &  \dots \\
		\frac{D}{h^2} & - \frac{2D+kh^2}{h^2} & \frac{D}{h^2} &  \dots &  \dots &  \vdots \\
	\vdots	&  \ddots &  \ddots &  \ddots &  &  \\
	\vdots	& \ddots & \ddots & \ddots &  &  \\
	\vdots	&  &  & \frac{D}{h^2} & - \frac{2D+kh^2}{h^2} & \frac{D}{h^2} \\
	\vdots	&  &  &  & \frac{2D}{h^2} & -\frac{2hS_R+2D+kh^2}{h^2}
	\end{bmatrix}
\end{equation}
